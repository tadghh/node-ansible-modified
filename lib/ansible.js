...
AbstractAnsibleCommand.prototype.addParam = function (
  commandParams,
  param,
  flag
) {
...
AbstractAnsibleCommand.prototype.addParamValue = function (
  commandParams,
  value,
  flag
) {
...
AbstractAnsibleCommand.prototype.addPathParam = function (
  commandParams,
  param,
  flag
) {
...
AbstractAnsibleCommand.prototype.commonCompileParams = function (
  commandParams
) {
...
var Playbook = function () {
  ...
  this.validate = function () {
    ...
    if (_.isUndefined(this.config.playbook) || _.isNull(this.config.playbook)) {
      ...
      !(this.config.playbook + "").endsWith("yml") ||
      !(this.config.playbook + "").endsWith("yaml")
    ) {
      errors.push("playbook name does not include .yaml or .yml");
    }
  ...
  this.compileParams = function () {
    var result = [this.config.playbook];
